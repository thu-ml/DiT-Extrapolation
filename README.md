...
<br>
This branch supports UltraImage for Flux. For Qwen-Image, please refer to the `ultra-qwenimage` branch.
...
```bash
CUDA_VISIBLE_DEVICES={gpu id} python infer_unified.py --config {your config path}
```
You can download the model [FLUX.1-dev](https://huggingface.co/black-forest-labs/FLUX.1-dev) and place it in your directory.
...
- We acknowledge the contribution of [FLUX.1](https://github.com/black-forest-labs/flux) and [QwenImage](https://github.com/QwenLM/Qwen-Image) for their great open-source model, and [Diffusers](https://github.com/huggingface/diffusers) for their great open-source framework.
